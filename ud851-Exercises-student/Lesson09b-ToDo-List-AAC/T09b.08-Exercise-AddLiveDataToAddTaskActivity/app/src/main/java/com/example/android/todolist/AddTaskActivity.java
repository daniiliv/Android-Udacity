            ...
            if (mTaskId == DEFAULT_TASK_ID) {
                ...
                task.observe(this, new Observer<TaskEntry>() {
                    ...
                    public void onChanged(@Nullable TaskEntry taskEntry) {
                        // Usually, we do not need to remove the observer as we want LiveData
                        // to reflect the state of the underlying data. In our case we are doing
                        // a one-time load, and we don’t want to listen to changes in the database.
