...
public class NotificationUtils {
     ...
     */
    private static final int WATER_REMINDER_NOTIFICATION_ID = 123;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        // This functionality exists since Android Oreo.
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mNotificationChannel =
                    new NotificationChannel(
                            WATER_REMINDER_NOTIFICATION_CHANNEL_ID,
                            context.getString(R.string.main_notification_channel_name),
                            NotificationManager.IMPORTANCE_HIGH); // Forces a notification to pop-up on the device
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                        ...
                        .setContentIntent(contentIntent(context)) // Notification will launch the app when clicked.
                        .setAutoCancel(true); // Notification will go away when clicked.
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN
            ...
            // Guarantee that a notification to pop-up on the devices earlier than Android Oreo.
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(
                ...
                startActivityIntent,
                PendingIntent.FLAG_UPDATE_CURRENT); // Flag keeps the pending intent valid and updates the extra data.
    }


    // v (4) Create a helper method called largeIcon which takes in a Context as a parameter and
    // returns a Bitmap. This method is necessary to decode a bitmap needed for the notification. (Displayed in the notification)
